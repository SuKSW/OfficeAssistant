...
@section('body')
    ...
    <div class="addUserForm">
        <form id="addUserForm"  action="/action_page.php">
            <h4>Add New User</h4>
            <div class="row">
            ...
            <div class="row">
                ...
                <select id="country" name="country">
                    <option value="australia">Department 1</option>
                    <option value="canada">Department 2</option>
                    <option value="usa">Department 3</option>
                </select></div></br></br>
    ...
    <div id="locateWindow" class="mini_window_background">
        <div class="mini_window">
            ...
            <div class="mini_window_button_section">
                ...
                <button type="button" onclick="locateFinishButton()">Finish</button>
